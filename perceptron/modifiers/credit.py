...
def modifier(item):
  return {
      "class": 1 if item['class'] == 'good' else -1,
      ...
      "credit_amount": int(item['credit_amount']) / 1000,
      ...
      "installment_commitment": int(item['installment_commitment']),
      ...
      "residence_since": int(item['residence_since']),
      ...
      "existing_credits": int(item['existing_credits']),
      ...
      "num_dependents": int(item['num_dependents']),
